...
<br>Place this file within the directory 'src/data'.
<br>Ensure the "big-endian?" and "visible human re-sampling?" check boxes are checked when selecting this file.
